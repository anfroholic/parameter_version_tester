...
class GRBL(Parameter):
    ...
    def __init__(self, *, 
        ...
        self.funcs = {
            ...
            'resume': self.resume,
            'reset_grbl': lambda *_: self.send_g(b'$BYE'),
        }
    ...
    def update(self):
        ...
        if save_data:
            self.work_offset = save_data['work_offset']
            self.work_offsets = save_data['work_offsets']
            self.tool_offset = save_data['tool_offset']
            self.tool_offsets = save_data['tool_offsets']
    ...
    def feed_hold(self, *args, **kwargs):
